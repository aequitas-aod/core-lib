...
def load_preproc_data_adult_aeq(unprivileged_groups, privileged_groups, protected_attributes=None, sub_samp=False, balance=False):
    '''
    adult_parent = load_preproc_data_adult()
    return AdultDataset(unprivileged_groups=unprivileged_groups,
                        privileged_groups=privileged_groups,
                        label_name=adult_parent.label_name,
                        favorable_classes=adult_parent.favorable_classes,
                        protected_attribute_names=adult_parent.protected_attribute_names,
                        privileged_classes=adult_parent.privileged_classes,
                        instance_weights_name=None,
                        categorical_features=adult_parent.categorical_features,
                        features_to_keep=adult_parent.features_to_keep,
                        na_values=adult_parent.na_values,
                        metadata=adult_parent.metadata
                        )
    '''
